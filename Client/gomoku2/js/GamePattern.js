...
var GamePattern = function() {
    this.prePattern = [ // Шаблоны построения фигур и их веса. "x" в дальнейшем заменяется на крестик (1) или нолик (2), 0 - свободная ячейка Les modèles de la construction des chiffres et leur poids. « X » est remplacée par une section supplémentaire (1) ou de l'orteil (2), 0 - cellule vide
       //{w:110000, p:['']}, 
        {w: 10000, p: ['xxxxx']}, // Пять в ряд. Победа 5 dans une rangé = victoire
